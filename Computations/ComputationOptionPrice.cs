...
{
    internal class ComputationOptionPrice: ComputationGlobal
    {
        ...
        //TODO DO the change for Option_info

        //Constructor
        public ComputationOptionPrice(
            DateTime date,
            double strike_price,
            double spot_price,
            double maturity,
        ...
        //Getters and Setters 
        public OptionInfo Option_info { get => option_info; set => option_info = value; }
